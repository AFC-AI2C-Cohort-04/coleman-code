...
*** WAIT 60 SECONDS AFTER VM BUILDS FROM IMAGE. THEN OPEN PORT 8080 AS AN INBOUND RULE FOR THE NETWORK SECURITY GROUP WITHIN THE SUBMITTER RESOURCE GROUP (THE JAVA APP WILL RESTART CONTINUOUSLY UNTIL IT CONNECTS) ***
